...
public class EspConnectActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "EspConnectActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_esp_connect);
    ...
    private void onWifiChanged(WifiInfo info) {
        ...
        if (!connected) {
            ...
            if (mTask != null) {
                ...
                mTask = null;
                new AlertDialog.Builder(EspConnectActivity.this)
    ...
    private void onEsptoucResultAddedPerform(final IEsptouchResult result) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(EspConnectActivity.this, text,
    ...
    private static class EsptouchAsyncTask4 extends AsyncTask<byte[], Void, List<IEsptouchResult>> {
        private WeakReference<EspConnectActivity> mActivity;
        ...
        EsptouchAsyncTask4(EspConnectActivity activity) {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog.setMessage("Esp is configuring, please wait for a moment...");
        ...
        protected List<IEsptouchResult> doInBackground(byte[]... params) {
            EspConnectActivity activity = mActivity.get();
            EspIPAddress.setGetAddressFlag(false);
            int taskResultCount;
            synchronized (mLock) {
        ...
        protected void onPostExecute(List<IEsptouchResult> result) {
            ...
            if (result == null) {
                mResultDialog.setMessage("Create Esp task failed, the esp port could be used by other thread");
                mResultDialog.show();
                return;
            }
            ...
            if (!firstResult.isCancelled()) {
                ...
                if (firstResult.isSuc()) {
                    ...
                    List<InetAddress> tempAddressList = new ArrayList();
                    for (IEsptouchResult resultInList : result) {
                        tempAddressList.add(resultInList.getInetAddress());
                        sb.append("Esp connect success!!!\nbssid = ")
                    ...
                    EspIPAddress.setmInetAddressList(tempAddressList);
                    EspIPAddress.setGetAddressFlag(true);
                    ...
                    mResultDialog.setMessage("Esp fail");
                }
